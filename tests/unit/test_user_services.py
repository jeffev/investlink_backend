...
from services.user_services import (
    list_users, view_user, new_user, edit_user, delete_user,
    login_user, validate_email, validate_username
)
    ...
    def test_new_user_success(self, app):
        ...
        with app.app_context():
            ...
            with patch('services.user_services.User.query') as mock_user_query, \
                 ...
                 patch('services.user_services.create_access_token') as mock_create_token:
