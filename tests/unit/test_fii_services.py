...
from services.fii_services import (
    list_fiis, view_fii, new_fii, edit_fii, delete_fii, 
    get_all_fiis_from_statusinvest, update_all_fiis
)
    ...
    def test_update_all_fiis_success(self, mock_get_fiis, app):
        ...
        with app.app_context():
            ...
            with patch('services.fii_services.Fii.query') as mock_fii_query, \
                ...
                mock_fii_query.filter.return_value.all.return_value = [mock_existing_fii]
