...
from services.user_layout_service import (
    get_user_layout, save_user_layout, delete_user_layout
)
...
class TestUserLayoutService:
    ...
    def test_get_user_layout_with_layout_success(self, app, sample_layout, sample_user):
        ...
        with app.app_context():
            ...
            mock_layout.estado = {'layout': 'Default', 'columns': ['ticker', 'price'], 'sorting': ['ticker']}

            with patch('services.user_layout_service.UserLayout.query') as mock_layout_query, \
                 patch('services.user_layout_service.db'):
                mock_layout_query.filter_by.return_value.first.return_value = mock_layout
    ...
    def test_get_user_layout_without_layout_success(self, app, sample_layout, sample_user):
        ...
        with app.app_context():
            ...
            with patch('services.user_layout_service.UserLayout.query') as mock_layout_query:
                mock_layout_query.filter_by.return_value.all.return_value = [mock_layout]
