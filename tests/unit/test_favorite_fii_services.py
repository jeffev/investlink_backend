...
def test_list_favorite_fiis_returns_user_favorites(mock_session, mock_query):
    ...
    fav1 = Favorite_FII(id=1, user_id=1, fii_ticker="KNRI11", ceiling_price=110.0, target_price=100.0)
    fav2 = Favorite_FII(id=2, user_id=1, fii_ticker="XPML11", ceiling_price=85.0, target_price=75.0)
...
@patch('services.favorite_fii_services.Favorite_FII.query')
@patch('services.favorite_fii_services.db.session')
def test_new_favorite_fii_validates_user_exists(mock_session, mock_fav_query, mock_fii_query, mock_user_query):
...
@patch('services.favorite_fii_services.Favorite_FII.query')
@patch('services.favorite_fii_services.db.session')
def test_new_favorite_fii_validates_fii_exists(mock_session, mock_fav_query, mock_fii_query, mock_user_query):
