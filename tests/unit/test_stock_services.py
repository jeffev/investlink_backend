...
from services.stock_services import (
    list_stocks, view_stock, new_stock, edit_stock, delete_stock,
    get_all_stocks_from_statusinvest, update_all_stocks, calculate_ey
)
    ...
    def test_update_all_stocks_success(self, mock_get_stocks, app):
        ...
        with app.app_context():
            ...
            with patch('services.stock_services.Stock.query') as mock_stock_query, \
                ...
                mock_stock_query.filter.return_value.all.return_value = [mock_existing_stock]
